...
const CAMPUS_DATA = {
  ...
  nodes: {
    gate: {
      id: "gate",
      name: "Main Entrance Gate",
      latlng: [12.863837, 77.434811]
    },
    second_gate: {
      id: "second_gate",
      name: "Second Gate",
      latlng: [12.864695, 77.435465]
    },
    sports: {
      id: "sports",
      name: "Sports Ground",
      latlng: [12.861767, 77.436512]
    },
    kns_canteen: {
      id: "kns_canteen",
      name: "KNS Canteen",
      latlng: [12.862902, 77.437322]
    },
    pu_block: {
      id: "pu_block",
      name: "PU Block",
      latlng: [12.860213, 77.437139]
    },
    chapel: {
      id: "chapel",
      name: "St. Kuriakose Elias Chavara Chapel",
      latlng: [12.860192, 77.437745]
    },
    mba_canteen: {
      id: "mba_canteen",
      name: "MBA Canteen",
      latlng: [12.863181, 77.437668]
    },
    block1: {
      id: "block1",
      name: "Academic Block I",
      latlng: [12.863032, 77.437944]
    },
    block2: {
      id: "block2",
      name: "Academic Block II",
      latlng: [12.862849, 77.438309]
    },
    open_air_auditorium: {
      id: "open_air_auditorium",
      name: "Open Air Auditorium",
      latlng: [12.862758, 77.438612]
    },
    block3: {
      id: "block3",
      name: "Academic Block III",
      latlng: [12.862624, 77.438845]
    },
    jonas_hall: {
      id: "jonas_hall",
      name: "Jonas Hall (Women's Hostel)",
    ...
    block4: {
      id: "block4",
      name: "Academic Block IV",
      latlng: [12.862515, 77.439151]
    },
    block5: {
      id: "block5",
      name: "Academic Block V",
      latlng: [12.861892, 77.438475]
    },
    south_canteen: {
      id: "south_canteen",
      name: "South Canteen",
      latlng: [12.862321, 77.439344]
    },
    block6: {
      id: "block6",
      name: "Academic Block VI",
      latlng: [12.862243, 77.439843]
    },
    architecture_block: {
      id: "architecture_block",
      name: "Architecture Block",
      latlng: [12.860036, 77.438394]
    },
    devadan: {
      id: "devadan",
      name: "Devadan Hall (Men's Hostel)",
      latlng: [12.859826, 77.440395]
    },
    north_canteen: {
      id: "north_canteen",
      name: "North Canteen",
      latlng: [12.859523, 77.439172]
    },
    devadan_ground: {
      id: "devadan_ground",
      name: "Devadan Ground",
    ...
    library: {
      ...
      latlng: [12.863, 77.43785]
    },
    road_gate_kns: {
      id: "road_gate_kns",
      name: "Main Driveway Curve",
      latlng: [12.863195, 77.436603]
    },
    road_kns: {
      id: "road_kns",
      name: "KNS Walkway Junction",
      latlng: [12.862651, 77.436833]
    },
    road_block1: {
      id: "road_block1",
      name: "Block I Walkway",
      latlng: [12.862682, 77.437719]
    },
    road_block2: {
      id: "road_block2",
      name: "Block II Walkway",
      latlng: [12.8628, 77.4382]
    },
    road_block3: {
      id: "road_block3",
      name: "Block III Walkway",
      latlng: [12.86265, 77.4387]
    },
    road_block4: {
      id: "road_block4",
      name: "Block IV Walkway",
      latlng: [12.86255, 77.43905]
    },
    road_block6: {
      id: "road_block6",
      name: "Block VI Walkway",
      latlng: [12.862018, 77.440108]
    },
    road_devadan: {
      id: "road_devadan",
      name: "Devadan Walkway Junction",
      latlng: [12.860454, 77.439891]
    },
    road_north_canteen: {
      id: "road_north_canteen",
      name: "Southern Campus Road Junction",
      latlng: [12.860496, 77.439151]
    },
    road_chapel: {
      id: "road_chapel",
      name: "Chapel Walkway Junction",
      latlng: [12.860627, 77.437901]
    },
    road_pu: {
      id: "road_pu",
      name: "PU Block Walkway Junction",
      latlng: [12.860553, 77.437257]
    },
    road_sports: {
      id: "road_sports",
      name: "Sports Ground Road",
      latlng: [12.861605, 77.437145]
    },
    road_block5: {
      id: "road_block5",
      name: "Block V Walkway",
      latlng: [12.862133, 77.438872]
    }
  },
  ...
  edges: [
    ...
    },
    {
      from: "second_gate",
      to: "road_gate_kns",
      direction: "Walk south-east along the perimeter road to the main driveway entrance."
    },
    {
      from: "gate",
      to: "road_gate_kns",
    ...
    },
    {
      from: "kns_canteen",
      to: "mba_canteen",
      direction: "Walk east along the canteen corridor to MBA Canteen."
    },
    {
      from: "road_kns",
      to: "road_sports",
    ...
    },
    {
      from: "road_sports",
      to: "pu_block",
      direction: "Walk south-east directly onto the PU Block walkway."
    },
    {
      from: "road_pu",
      to: "pu_block",
    ...
    },
    {
      ...
      direction: "Walk south-east directly to the Architecture Block."
    },
    {
      from: "road_chapel",
      to: "road_block5",
    ...
    },
    {
      from: "road_block5",
      to: "road_block3",
      direction: "Walk north-west through the central courtyard to the Block III area."
    },
    {
      from: "road_block5",
      to: "road_block4",
      direction: "Walk north-east through the central courtyard to the Block IV area."
    },
    {
      from: "road_block5",
      to: "road_block1",
    ...
    },
    {
      from: "south_canteen",
      to: "road_block5",
      direction: "Walk south-west along the courtyard path to Block V."
    },
    {
      from: "south_canteen",
      to: "road_block4",
    ...
    },
    {
      from: "block2",
      to: "open_air_auditorium",
      direction: "Walk east from Block II directly to the Open Air Auditorium."
    },
    {
      from: "road_block2",
      to: "road_block1",
    ...
    },
    {
      from: "block1",
      to: "block2",
      direction: "Walk through the connecting corridor between Block I and Block II."
    },
    {
      from: "road_block1",
      to: "library",
